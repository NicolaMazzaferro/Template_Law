    ...
    <div class="container-fluid">
      <div class="row text-center">
        ...
        <div class="col-12 col-md-4 my-5">
          ...
          <a href={{route('about_us_detail', ['id' => $about['id']])}} ><img class="rounded-circle profile my-5" src={{$about['img']}} alt="profile"></a>

          <h2 class="darkBrown ff-title">{{$about['name']}} {{$about['surname']}}</h2>

          <h6 class="brown">{{$about['role']}}</h6>
