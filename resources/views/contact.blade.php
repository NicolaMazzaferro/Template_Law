...
<html lang="en">
  ...
  <body>
    ...
    <div class="container layoutContactPage">
      <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Email</label>
        <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
      </div>
      <div class="mb-3">
        <label for="exampleFormControlTextarea1" class="form-label">Fai una breve descrizione del servizio di cui hai bisogno:</label>
        <textarea class="form-control" id="exampleFormControlTextarea1" rows="8" placeholder="Es: reati contro la persona, cartelle esattoriali, diritto di famiglia, etc"></textarea>
      </div>
      <div class="text-center">
        <a href="#"><button class="buttonAbout">INVIA</button></a>
      </div>
    </div>
